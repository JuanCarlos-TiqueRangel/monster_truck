...
#         dxpos_mean, _       = self.gp_xpos.predict_torch(X)
#         dxpos_dot_mean, _   = self.gp_xpos_dot.predict_torch(X)
#         dpitch_mean, _      = self.gp_pitch.predict_torch(X)
#         dpitch_dot_mean, _  = self.gp_pitch_dot.predict_torch(X)
