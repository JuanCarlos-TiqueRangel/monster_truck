...
class MPPITorch:
    ...
    def solve(self, state, ref, tau_prev):
        ...
        e = s - ref
        goal_terminal_cost = cfg.q_x * e[:, 0] ** 2
        speed_terminal_cost = cfg.q_v * e[:, 1] ** 2
        pitch_terminal_cost = cfg.q_theta * e[:, 1] ** 2
        pitch_rate_terminal_cost = cfg.q_omega * e[:, 1] ** 2
        


        J = J + (goal_terminal_cost
                 + speed_terminal_cost
                 + pitch_terminal_cost
                 + pitch_rate_terminal_cost
        )
